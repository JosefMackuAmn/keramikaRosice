...
/* harmony import */ var _utils_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/state */ "./src/js/utils/state.js");
...
_utils_functions__WEBPACK_IMPORTED_MODULE_2__.ready(() => {
    ...
    if (params.has('payment')) {
        ...
        if (payment === 'success') {
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Úspěch', 'Platba proběhla úspěšně. Faktura k objednávce Vám přišla na e-mail.', 'OK')
        } else if (payment === 'canceled') {
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Storno', 'Platba byla přerušena, ale prodejce byl o Vaší objednávce informován a kontaktuje Vás.', 'OK')
        }
        ...
        if(payment === 'BTR') {
            ...
            if(params.has('success') && params.has('mailSent')) {
                ...
                if(success === 'true' && mailSent === 'true') {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Odesláno', 'Objednávka byla odeslána. <em>Byl vám zaslán mail s pokyny k platbě.</em>', 'OK', true)
                }

                if(success === 'true' && mailSent === 'false') {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Nepovedlo se odeslat e-mail', '<em> Objednávku jsme zaregistrovali, ale nepodařil se odeslat mail s informacemi k platbě. Prosím, kontaktujte mě na adrese keramikarosice@seznam.cz </em>', 'OK', true)
                }

                if(success === 'false' && mailSent === 'true') {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Chyba', 'Nastala chyba, objednávku se nepodařilo odeslat.', 'OK')
                }
        ...
        if(payment === 'DOB') {
            ...
            if(params.has('success') && params.has('mailSent')) {
                ...
                if(success === 'true' && mailSent === 'true') {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Úspěch', 'Objednávka proběhla úspěšně. Faktura vám přišla na mail.', 'OK')
                }

                if(success === 'true' && mailSent === 'false') {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.createModal('Úspěch', 'Objednávka proběhla úspěšně', 'OK')
                }
    ...
    const hamburgerBtn = _utils_state__WEBPACK_IMPORTED_MODULE_1__.default.hamburgerBtn = document.querySelector("#hamburger-btn");
    ...
    const toggleHeader = (e) => {
        ...
        if(![hamburgerBtn.classList].includes('header__nav-button--hiding')) {
            ...
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(hamburgerBtn, 'header__nav-button--show', 'header__nav-button--hide', 'header__nav-button--hiding');
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(headerList, 'header__nav-list--hidden', 'header__nav-list--visible', 'header__nav-list--hiding');
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(headerBackDrop, 'header__backdrop--hidden', 'header__backdrop--visible', 'header__backdrop--hiding');

            for (const listItem of headerList.children) {
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(listItem, 'header__nav-item--hidden', 'header__nav-item--visible', 'header__nav-item--hiding');
            }
        }
    }
    ...
    if (categoriesSlider) {
        ...
        arrowLeft.addEventListener("click", () => {
            _utils_state__WEBPACK_IMPORTED_MODULE_1__.default.categoriesSlider.selectedArr = 'left';
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.moveCategoriesSlider();
        });
        arrowRight.addEventListener("click", () => {
            _utils_state__WEBPACK_IMPORTED_MODULE_1__.default.categoriesSlider.selectedArr = 'right';
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.moveCategoriesSlider();
        });        
    }
    ...
    if (orderForm) {
        orderForm.addEventListener('submit', _utils_ajax__WEBPACK_IMPORTED_MODULE_3__.orderSubmitHandler);

        _utils_functions__WEBPACK_IMPORTED_MODULE_2__.updateCartPage();
    }
    ...
    if(orderForm) {
        ...
        agreeGDPR.addEventListener('change', () => {
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.refreshSubmitBtn(agreeGDPR, agreeConditions, submitToCartBtn);
        })
    ...
    ///// Input Validation
    if(orderForm) {
        for (const input of _utils_data__WEBPACK_IMPORTED_MODULE_4__.formELs) {
            input.addEventListener('input', _utils_functions__WEBPACK_IMPORTED_MODULE_2__.validateInput.bind(undefined, input));
        }
    }
    ...
    if(orderForm) {
        ...
        orderDelivery.addEventListener('input', (event) => {
            ...
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.validateInput(_utils_data__WEBPACK_IMPORTED_MODULE_4__.formELs.delivery);
        ...
        orderPayment.addEventListener('input', () => {
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.validateInput(_utils_data__WEBPACK_IMPORTED_MODULE_4__.formELs.payment);
        })
    ...
    if(orderForm) {
        ...
        orderForm.querySelector('#firstName').addEventListener('input', _utils_functions__WEBPACK_IMPORTED_MODULE_2__.easterTime.bind(undefined, frogAudio));
        ...
        for(const cartItem of cartItems) {
            ...
            addButton.addEventListener('click', async () => {
                ...
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.addToCart(postCartData).then((updatedCart) => {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.updateCartItem(cartItem, updatedCart);
                });
            });
            removeButton.addEventListener('click', () => {
                ...
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.removeFromCart(postCartData).then((updatedCart) => {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.updateCartItem(cartItem, updatedCart);
    ...
    if (eshopProducts) {
        ...
        for (const btn of submitBtns) {
            btn.addEventListener('click', () => {
                ...
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.addToCart(postCartData).then((updatedCart) => {
                    _utils_functions__WEBPACK_IMPORTED_MODULE_2__.updateCartIcon(updatedCart);
    ...
    if (categorySelect) {
        ...
        for (const btn of categorySelectButtons) {
            ...
            btn.addEventListener('click', () => {
                ...
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.switchClass(btn, 'category-select__button--show', 'category-select__button--hide');
                // shows or removes the subcategory list
                if(list) {_utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(list, 'category-select__subcategory-list--hidden', 'category-select__subcategory-list--visible', 'category-select__subcategory-list--hiding');}
            });
        }
        ...
        for (const prod of products) {
            ...
            btnShowProdModal.addEventListener('click', () => {
                // Shows product modal
                _utils_functions__WEBPACK_IMPORTED_MODULE_2__.switchClass(modal, 'product__modal--toggled', 'product__modal--hidden');
        ...
        const toggleCategorySelect = () => {
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(categorySelectList, 'category-select__category-list--hidden', 'category-select__category-list--visible', 'category-select__category-list--hiding');
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(categorySelectHeading, 'heading-2--hidden', 'heading-2--visible', 'heading-2--hiding');
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.showOrHideEl(categorySelectBackdrop, 'category-select__backdrop--hidden', 'category-select__backdrop--visible', 'category-select__backdrop--hiding');
            _utils_functions__WEBPACK_IMPORTED_MODULE_2__.switchClass(categorySelectMobileBtn, 'category-select__mobile-button--show', 'category-select__mobile-button--hide');
...
const orderSubmitHandler = e => {
    ...
    const packetaIdValue = deliveryValue === 'ZAS' ? _functions__WEBPACK_IMPORTED_MODULE_0__.validateInput(_data__WEBPACK_IMPORTED_MODULE_1__.formELs.packetaId) : '';
    ...
    if (paymentValue === 'CRD') {
        ...
        fetch('/objednavka', {
            ...
            if (result.error) {
                _functions__WEBPACK_IMPORTED_MODULE_0__.createModal('Nastala chyba', 'Platba kartou se nezdařila. Prosím, zkuste jiný typ platby nebo mě kontaktujte na e-mailu keramikarosice@seznam.cz.', 'OK');
            }
        }).catch(err => {
            _functions__WEBPACK_IMPORTED_MODULE_0__.createModal('Nastala chyba', 'Platba kartou se nezdařila. Prosím, zkuste jiný typ platby nebo mě kontaktujte na e-mailu keramikarosice@seznam.cz.', 'OK');
        }).finally(() => {
