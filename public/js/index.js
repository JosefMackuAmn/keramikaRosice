...
/*! CommonJS bailout: this is used directly at 349:86-90 */
...
_utils_functions__WEBPACK_IMPORTED_MODULE_3__.ready(() => {
    ...
    if (params.has('payment')) {
        ...
        if (payment === 'success') {
            ...
            _utils_functions__WEBPACK_IMPORTED_MODULE_3__.createModal('Storno', 'Platba byla přerušena, ale prodejce byl o Vaší objednávce informován a kontaktuje Vás.', 'OK')
        }
